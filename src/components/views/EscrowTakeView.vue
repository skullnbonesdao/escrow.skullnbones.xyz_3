    ...
    <q-card flat class="">
            ...
            <q-expansion-item icon="info" label="Details" dense>
                <template v-slot:header>
                    <div class="full-width">
                        <q-btn-group
                            flat
                            class="text-center full-width row items-center"
                        >
                            <div class="q-ml-md">
                                <div class="row">
                    ...
                    <div class="col">
                        <div class="row q-gutter-x-sm">
                            <div class="col text-right items-center">
                                {{
                                    useEscrowStore().escrow_selected?.account.price.toFixed(
                                        10
                                    ) ?? 0
                                }}
                            </div>
        ...
        >
            <BuySellTokenInputElemenet
                ...
                "
                @amountChange="(value) => (amount_to_sell = value)"
            />
            ...
            <BuySellTokenInputElemenet
                ...
                :token_input="token_depostit_info"
                :disable="
                    !useEscrowStore().escrow_selected?.account.allowPartialFill
                "
                @amountChange="(value) => (amount_to_buy = value)"
            />
            <q-btn-group class="full-width q-pa-sm">
                <div class="col">
                    <div class="row items-center">
                        <q-slider
                            ...
                            @update:model-value="
                            (data: any) => calculate_side('sell', data)
                        "
                            :disable="
                                !useEscrowStore().escrow_selected?.account
                                    .allowPartialFill
                            "
                            :min="0"
                            :max="
                                ...
                                Math.pow(
                                    10,
                                    -(token_depostit_info?.decimals ?? 0)
                                )
                            "
                            color="blue"
                            track-size="10px"
        ...
        <q-card-section>
            <q-btn-group class="full-width">
                <div class="col">
                    ...
                    <div
                        class="row items-center text-subtitle2 q-gutter-x-sm q-ma-sm"
                    >
                        <div class="col">
                        ...
                        <q-avatar size="sm" color="white">
                            <img
                                :src="
                                    token_request_info?.logoURI ?? 'unknown.png'
                                "
                            />
                        </q-avatar>
                    </div>
