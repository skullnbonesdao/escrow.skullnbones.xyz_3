    ...
    <q-card style="max-width: 600px" bordered>
        ...
        <q-card-section class="row q-gutter-x-md">
            <BuySellTokenInputElemenet
                ...
                @tokenChange="(value: I_Token) => (useEscrowStore().new_escrow.deposit_token = value)"
                @amountChange="(value:number) => (useEscrowStore().new_escrow.deposit_amount = value)"
            />
            ...
            <BuySellTokenInputElemenet
                ...
                @tokenChange="(value: I_Token) => (useEscrowStore().new_escrow.request_token = value)"
                @amountChange="(value:number) => (useEscrowStore().new_escrow.request_amount = value)"
            />
        </q-card-section>
