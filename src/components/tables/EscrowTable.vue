...
function make_take_view(escrow) {
    if (expandable.value) {
        if (
        ...
        <template v-slot:body="props">
            <q-tr :props="props" @click="make_take_view(props.row)">
                    ...
                    <div class="q-gutter-y-xs">
                        <div class="row items-center justify-around no-wrap">
                            ...
                            <div class="q-mx-sm text-subtitle1">
                                {{
                                    get_token_name_from_mint(
                                        props.row.account.requestToken
                                    )
                                }}
                            </div>
                            <TokenIcon
                ...
                <q-td key="size" :props="props">
                    <div class="q-gutter-y-xs">
                        <div
                            class="row items-center justify-end q-gutter-x-sm no-wrap"
                        >
                            <FormatTokenNumber
                ...
                <q-td key="ppu" :props="props">
                    <div class="q-gutter-y-xs">
                        ...
                        >
                            <div class="text-subtitle2">
                                {{
                                    (1 / props.row.account.price).toFixed(
                                        decimals
                                    )
                                }}
                            </div>
